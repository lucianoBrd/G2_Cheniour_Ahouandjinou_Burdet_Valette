$(document).ready(function () {
    ...
    session.service("ALMemory").done(function (ALMemory) {
        ...
        ALMemory.subscriber("LMode").done(function (subscriber) {

            subscriber.signal.connect(function (data) {
                const label = data;

                $('.titlemode').html('Mode actuel: ' + label);
            });
        });
