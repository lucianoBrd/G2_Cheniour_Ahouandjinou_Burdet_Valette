$(document).ready(function () {
    ...
    session.service("ALMemory").done(function (ALMemory) {
        ...
        ALMemory.subscriber("Mode").done(function (subscriber) {
